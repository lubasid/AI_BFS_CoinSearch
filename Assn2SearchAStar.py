...
START_X = 30 # HARDCODED  Start X coordinate of search path
START_Y = 300 # HARDCODED  Start Y coordinate of search path
GOAL_X = 370 # HARDCODED  Goal X coordinate of search path
GOAL_Y = 350 # HARDCODED  Goal Y coordinate of search path
...
currentPriority = 1  # Initialize to a "low" (sooner returned) priority for pri. queue
...
def priority(cx, cy):  # (cx, cy) is the coordinate of the Current state
	...
	# A* Search -- priority is the A* formula
	...
	currentPriority = ????COMPLETE THIS LINE????
